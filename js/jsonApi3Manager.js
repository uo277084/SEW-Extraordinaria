...
class JSONManager {
    ...
    /*
        getIdCountry(apikey, countryName, getIdCompetition, getIdTeam, getIdPlayers) {
            $.ajax({
                dataType: "json",
                url: "https://v3.football.api-sports.io/countries?name=" + countryName,
                method: 'GET',
                headers: {
                    "x-rapidapi-key": apikey
                },
                success: function (data) {
                    var country = data.response[0];
                    getIdCompetition(apikey, countryName, "Segunda División", getIdTeam, getIdPlayers);
                },
                error: function () {
        ...
        getIdCompetition(apikey, countryName, leagueName, getIdTeam, getIdPlayers) {
            var url = "https://v3.football.api-sports.io/leagues?name=" + leagueName + "&country=" + countryName;
            $.ajax({
                dataType: "json",
                url: url,
                method: 'GET',
